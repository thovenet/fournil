...
ui <- fluidPage(theme = shinytheme("cosmo"),
  ...
  navbarPage(icon(sample(c("jar-wheat", "money-bill-trend-up", "money-bill-wheat", "people-group", "person-digging", "person-harassing", 
                           ...
                           "building-wheat", "atom", "rocket","gears", 'thumbs-up', "truck", "paper-plane", "dragon", "otter", "paw", "gamepad",
                           "fire-extinguisher", "scroll", "sliders", "shopify","registered", "shield-dog", "wheat-awn"),1)),
   ...
   tabPanel(icon("readme"), 
            h1("Comment utiliser ce truc ?!"),
            h2(strong("En fait, c'est très simple : à partir d'une commande (une quantité de pain à fabriquer), l'outil aide à composer des fournées cohérentes, à calibrer les recettes et à planifier la journée de boulot. C'est donc un outil pratique qui porte très bien son nom.")),
          br(),  
          ...
          br(),
            ...
            div(p("La commande peut ensuite être répartie en fournées cohérentes. L’onglet ", 
                strong("« Pratique 2 »"), "affiche la distribution des pains commandés en fournées de manière à maximiser le remplissage du four et à minimiser les types de recettes pour chaque fournée : on cherche à remplir les fours avec des pains qui se ressemblent le plus possible en termes de recette."),
