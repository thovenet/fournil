...
ui <- fluidPage(theme = shinytheme("cosmo"),
                disconnectMessage(text = "ZZZzzz...", refresh = "Relancer la page",
                  background = "#FFFFFF", colour = "#444444", refreshColour = "#337AB7",
                  overlayColour = "#566157", overlayOpacity = 0.6, width = "full",
  ...
  navbarPage(icon(sample(c("money-bill-wheat", "plate-wheat", "building-wheat", "wheat-awn",
   ...
   ## Read-me ----
   tabPanel(div("Mode d'emploi",icon("scroll")), 
          ...
          br(),
            ...
            div(p("Une fois la commande renseignée, on peut la convertir en", strong("quantité de pâte"), "à produire, en distinguant les types de pains voulus. 
                ...
                code(tags$i(p("Quantité brute (en g) = [Nb de pains de 500g commandés * 500] + [Nb de pains de 750g commandés * 750]"),
                            p("Marge à ajouter = Quantité brute * Coef de marge"),
                            p("Quatité finale (en g) = Quantité brute + Marge à ajouter")),  .noWS = c("outside", "after-begin", "before-end")),
